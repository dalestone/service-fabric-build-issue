...
REM "%msbuildpath%\msbuild" %~dp0\..\src\Iot.Ingestion.Application\Iot.Ingestion.Application.sfproj /t:Package /p:Platform=x64
REM "%msbuildpath%\msbuild" %~dp0\..\src\Iot.Tenant.Application\Iot.Tenant.Application.sfproj /t:Package /p:Platform=x64
